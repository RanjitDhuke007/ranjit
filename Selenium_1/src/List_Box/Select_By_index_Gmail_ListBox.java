...
public class Select_By_index_Gmail_ListBox {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement month = driver.findElement(By.xpath("//select[@id='month']"));
		 ...
		 Thread.sleep(3000);
		 List<WebElement> bmonth = m.getOptions();
		 System.out.println(bmonth.size());
		 for(WebElement np:bmonth)
		 {
		 ...
		 Thread.sleep(3000);
		 List<WebElement> gen = g.getOptions();
		 System.out.println(gen.size());
		 for(WebElement gn:gen)
		 {
			 System.out.println(gn.getText());
		 }
		 Thread.sleep(4000);
		 // Next Button...
